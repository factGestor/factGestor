...
public class SolicitarInformesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	public void doGet(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {

		System.out.println("hemos entrado en SolicitarInformesServlet");
		...
		/*
		 * TRAZAS System.out.println(dominiosLista.get(0).getDomain());
		 * System.out.println(dominiosLista.get(0).getUserId());
		 */

		// pasar parametros
		misession.setAttribute("u", u);
		misession.setAttribute("dominios",
				new ArrayList<Dominio>(dominiosLista));

		RequestDispatcher view = req.getRequestDispatcher("solicitarInforme.jsp");
